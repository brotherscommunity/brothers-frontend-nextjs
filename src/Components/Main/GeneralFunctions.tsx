...
export default function GeneralFunctions() {
    ...
    return (
        <section>
            ...
            <div className="flex flex-wrap w-[340px] items-center max-sm:gap-8 sm:justify-between mt-10">
            ...
            <div className="flex flex-wrap w-[300px] items-center max-sm:gap-8 sm:justify-between mt-10">
            ...
            <div className="flex flex-wrap w-[380px] items-start max-sm:gap-8 sm:justify-between mt-10">
                <label className="text-base text-black font-palanquin"> Message </label>
                <textarea disabled={isLoading} onChange={(e) => setState({...state, message: e.target.value})} className="w-[280px] h-[140px] bg-button border border-gray-400 disabled:cursor-not-allowed focus-visible:outline-none px-5 py-2.5 rounded-md" />
            </div>
